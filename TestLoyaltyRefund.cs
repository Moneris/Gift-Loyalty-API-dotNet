namespace Moneris
{
	...
	public class TestLoyaltyRefund
	{
	  public static void Main(string[] args)
	  {
	        ...
	        ErnexLoyaltyRefund ernexLoyaltyRefund = new ErnexLoyaltyRefund(order_id, txn_number, total_amount, benefit_amount);

            ernexLoyaltyRefund.SetInfo(info); //optional

            ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexLoyaltyRefund);
