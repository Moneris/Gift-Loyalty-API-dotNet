namespace Moneris
{
	...
	public class TestGiftRefund
	{
	  public static void Main(string[] args)
	  {
            ...
            ErnexGiftRefund ernexGiftRefund = new ErnexGiftRefund(order_id, txn_number);

            ernexGiftRefund.SetCvdValue(cvd_value); //optional
            ernexGiftRefund.SetInfo(info); //optional

	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexGiftRefund);
