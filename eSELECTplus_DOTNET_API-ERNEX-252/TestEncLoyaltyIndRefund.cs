...
{
    using System;
	public class TestEncLoyaltyIndRefund
	{
	  public static void Main(string[] args)
	  {
            ...
            string benefit_amount = args[8];
                       
	        EncErnexLoyaltyIndRefund ernexLoyaltyIndRefund = new EncErnexLoyaltyIndRefund(order_id, cust_id, total_amount, 
                track2, language_code, benefit_amount);
	        ...
	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexLoyaltyIndRefund);
