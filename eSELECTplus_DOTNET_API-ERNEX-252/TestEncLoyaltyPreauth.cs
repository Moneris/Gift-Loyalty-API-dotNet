...
{
    using System;
	public class TestEncLoyaltyPreauth
	{
	  public static void Main(string[] args)
	  {
            ...
            EncErnexLoyaltyPreauth ernexLoyaltyPreauth = new EncErnexLoyaltyPreauth(order_id, total_amount, 
                track2, language_code, benefit_amount, payment_type);
	        	
            ernexLoyaltyPreauth.SetCvdValue(cvd_value); //optional
            ernexLoyaltyPreauth.SetInfo(info); //optional

	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexLoyaltyPreauth);
