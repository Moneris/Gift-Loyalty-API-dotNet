namespace Moneris
{
	...
	public class TestGiftVoid
	{
	  public static void Main(string[] args)
	  {
	        ...
	        string cvd_value = args[3]; //optional
            string txn_number = args[4];

            ErnexGiftVoid ernexGiftVoid = new ErnexGiftVoid(order_id, txn_number);

            ernexGiftVoid.SetCvdValue(cvd_value); //optional

	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexGiftVoid);
