namespace Moneris
{
	...
	public class TestEncLoyaltyRedemption
	{
	  public static void Main(string[] args)
	  {
            ...
            string info = args[6];
            string benefit = args[7];
                        
            EncErnexLoyaltyRedemption ernexLoyaltyRedemption = new EncErnexLoyaltyRedemption(order_id, total_amount, 
                track2, language_code, benefit);
	        ...
	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexLoyaltyRedemption);
