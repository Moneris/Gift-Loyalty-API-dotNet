namespace Moneris
{
	...
	public class TestGiftActivation
	{
	  public static void Main(string[] args)
	  {
            ...
            ErnexGiftActivation ernexGiftActivation = new ErnexGiftActivation(order_id, cust_id, initial_amount,
                track2, pan, expdate, language_code);

            ernexGiftActivation.SetCvdValue(cvd_value); //optional
            ernexGiftActivation.SetInfo(info); //optional

            ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexGiftActivation);
	        try
	        {
