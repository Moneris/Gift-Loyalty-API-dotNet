namespace Moneris
{
	...
	public class TestGiftDeactivation
	{
	  public static void Main(string[] args)
	  {
            ...
            ErnexGiftDeactivation ernexGiftDeactivation = new ErnexGiftDeactivation(order_id, track2, pan, expdate, language_code);

            ernexGiftDeactivation.SetCvdValue(cvd_value); //optional
            ernexGiftDeactivation.SetInfo(info); //optional

	        ErnexHttpsPostRequest mpgReq =
	            new ErnexHttpsPostRequest(host, store_id, api_token, ernexGiftDeactivation);
	        try
	        {
