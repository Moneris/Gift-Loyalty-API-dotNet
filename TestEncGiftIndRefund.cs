...
{
    using System;
	public class TestEncGiftIndRefund
	{
	  public static void Main(string[] args)
	  {
            ...
            string reference_number = args[7];

            EncErnexGiftIndRefund ernexGiftIndRefund = new EncErnexGiftIndRefund(order_id, cust_id, total_amount, track2, 
                            language_code, info, reference_number);

            ernexGiftIndRefund.SetCvdValue(cvd_value); //optional

	        ErnexHttpsPostRequest mpgReq = new ErnexHttpsPostRequest(host, store_id, api_token, ernexGiftIndRefund);
