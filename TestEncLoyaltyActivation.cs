namespace Moneris
{
	...
	public class TestEncLoyaltyActivation
	{
	  public static void Main(string[] args)
	  {
            ...
            EncErnexLoyaltyActivation ernexLoyaltyActivation = new EncErnexLoyaltyActivation (order_id, cust_id, 
                initial_amount, track2, language_code);
